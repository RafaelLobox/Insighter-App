  ...
  return (
    <SafeAreaView  style={{backgroundColor:'#F6F4F3', flex: 1}}>
      <View style={styles.header}>
        ...
        <Text style={{fontSize: 20, fontWeight: 'bold', paddingLeft: 12}}> Cadastro de Máquinas</Text>
      </View>
      <ScrollView
      contentContainerStyle={{
        ...
        <Text style={{color: 'black', fontSize: 40, fontWeight: 'bold'}}>Cadastro de</Text>
        <Text style={{color: COLORS.blue, fontSize: 40, fontWeight: 'bold'}}>Maquinas</Text>

        <Text style={{color: 'grey', fontSize: 18, marginVertical: 10}}>Insira os Dados da Máquina</Text>
